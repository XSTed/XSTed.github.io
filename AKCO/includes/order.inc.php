...
function generateItem($item, $cartItem, $memberID){
  ...
  // admin view orders
  [$itemID, $quantity, $quantityInStock, $image, $itemName, $price, $quantityDisplay, $orderItemID, $dateAdded, $categoryName] = generateOrderDetails($item, $cartItem, $memberID);
    ...
    <li>
      <form method='GET' class='collapsible-header collapsible-card bold center'>
        ...
        <p class='col s2' style='padding: 0px; margin: 0px;'>
          <img class='shadow-img' src='product_img/$image'
