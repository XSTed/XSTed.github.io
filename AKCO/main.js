...
function initRenderer() {
    ...
    document.getElementById('containerProd').appendChild(renderer.domElement);
}
...
//             let product = data[i];
//             let element = htmlElement(product);
...
function htmlElement(table,i) {
    ...
    // let symbol = document.createElement('div');  // 換圖
    // symbol.className = 'symbol';
    // symbol.textContent = table[i];
    // element.appendChild(symbol);

    let productImage = document.createElement('img');  // 換圖
    productImage.className = 'symbol';
    productImage.src = "./product_img/4.png";
