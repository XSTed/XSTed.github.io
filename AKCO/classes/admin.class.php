...
class Admin extends Dbhandler{
        ...
        <tr>
          <td id='bordershadow'>
            <a href='product.php?item_id=$itemID'>
              <div><img class='shadow-img' src='product_img/$image' style='height: 58px; float: left; max-width: 68px; display: block; 
  ...
  protected function inspectProduct(){
    ...
    while ($row = $result->fetch_assoc())    
    {
      ...
      echo(
        "<tr>
          <td><img class='shadow-img' src='product_img/$image' style='height:100px;'></td>
          <td>$name</td>
          <td>$brand</td>
          <td>$description</td>
