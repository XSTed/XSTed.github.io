          ...
          <table class="responsive-table">
            <tbody>
              <?php
                ...
                if ($displayShipping === 0) $displayShipping = "<span class='underline'>NT$displayShipping</span>";
                else $displayShipping = "NT$displayShipping";

                if ($sumTotal >= 2000){
                  $shippingTotal = $sumTotal - 100;
                  $displayPVoucher = "<span class='underline'>-NT100</span> <span class='yellow-text'>(Promo voucher applied)</span>";
                }
                ...
                echo("<tr><th>Sum Total:</th><td>NT$sumTotal</td></tr>");
